...
struct RefuelRecordingTests {
    ...
    private func world(_ spy: Spy) -> World {
        ...
        world = World(
            ...
            releaseSpeedVoice: world.releaseSpeedVoice,
            releaseDirectionsVoice: world.releaseDirectionsVoice,
            ...
            launchWatchApp: world.launchWatchApp,
