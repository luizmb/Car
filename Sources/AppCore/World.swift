...
public struct World: Sendable {
    ...
    /// The quickest route to each of several targets, asked for concurrently. Used when rejoining
    /// a route, where the candidates have to be compared before one can be picked.
